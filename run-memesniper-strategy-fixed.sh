...
# Pre-calculated values to avoid using bc
ENTRY_PRICE="0.0000000111" # in SOL
EXIT_PRICE="0.0000000389"  # 3.5x entry
STOP_LOSS_PRICE="0.0000000089"  # 0.8x entry
TOKEN_AMOUNT="18000000"
FINAL_VALUE="0.7002" # pre-calculated value in SOL
INITIAL_VALUE="0.2"   # SOL
PROFIT="0.5002"  # SOL
PROFIT_PERCENTAGE="250.1"  # %
...
echo -e "Setting take profit at ${EXIT_MULTIPLIER}x: $EXIT_PRICE SOL"
echo -e "Setting stop loss at ${STOP_LOSS}x: $STOP_LOSS_PRICE SOL"
...
VALUES=("0.2000" "0.2628" "0.3204" "0.3870" "0.4806" "0.5616" "0.7002")
...
for i in "${!PRICES[@]}"; do
    echo -e "| ${TIMES[$i]}    | ${PRICES[$i]} | ${MULTIPLES[$i]}    | ${VALUES[$i]} SOL${NC} |"
    sleep 0.5
done
...
echo -e "  Sold $TOKEN_AMOUNT $TARGET_TOKEN for $FINAL_VALUE SOL"
echo -e "  Initial investment: $INITIAL_VALUE SOL"
...
echo -e "Final amount: $FINAL_VALUE SOL"
