/**
 * Updated market analysis signal generator that fixes timestamp issues
 */

import { logger } from './server/logger';
import { EventEmitter } from 'events';
import { perplexityAI } from './server/perplexity-integration';
import { localMarketAnalysis } from './server/lib/localMarketAnalysis';
import { signalHub } from './server/signalHub';
import { 
  SignalType, 
  SignalStrength, 
  SignalDirection, 
